...
<head>
    ...
    <title>All New Books — Classic Modern</title>
    ...
    <style>
        ...
        *, *::before, *::after { border-radius: 0 !important; }
        ...
        .badge-custom { font-size: 0.65rem; padding: 4px 8px; text-transform: uppercase; font-weight: 800; color: #fff; display: inline-block; background: var(--c-accent); }
    </style>
</head>
<body>
    ...
    <div class="container my-5">
        <div class="d-flex align-items-center justify-content-between mb-4 section-header">
            <h4 class="section-title mb-0 d-flex align-items-center">
                <i class="fas fa-sparkles me-2" style="color: var(--c-accent);"></i> All New Books
            </h4>
            ...
            <div class="row justify-content-center my-5">
                <div class="col-md-6 text-center">
                    <div class="p-5 border border-2 bg-white" style="border-color: var(--c-border) !important;">
                        ...
                        <h5 class="fw-bold mb-2 text-uppercase">No New Books Available</h5>
                        <p class="text-muted small mb-4">We haven't added any new books yet. Check back soon for fresh arrivals!</p>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card h-100 book-card p-3">
                        ...
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                            <div>
                                <span class="badge badge-custom mb-2">New</span>
