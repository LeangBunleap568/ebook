...
<head>
    ...
    <title>All Old Books - Classic Modern</title>
    <%@include file="../component/rootCss.jsp" %>
    <style>
        :root { --c-bg: #f4f6f8; --c-surface: #ffffff; --c-border: #cbd5e1; --c-text: #1e293b; --c-muted: #64748b; --c-accent: #2d6a4f; --c-accent-hover: #1b4332; --c-price: #b91c1c; --c-old-badge: #d97706; }
            ...
            <div class="row justify-content-center my-5">
                <div class="col-md-6 text-center">
                    <div class="p-5 border border-2 bg-white" style="border-color: var(--c-border) !important;">
                        ...
                        <h5 class="fw-bold mb-2 text-uppercase">No Old Books Available</h5>
                        <p class="text-muted small mb-4">There are no old books in the catalog at the moment.</p>
                ...
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="card h-100 book-card p-3">
                        ...
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                            <div>
                                <span class="badge badge-custom mb-2">Old</span>
